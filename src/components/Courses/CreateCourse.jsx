...
const CreateCourse = (props) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setLoading(true);
        axios.post(`${HOST}/courses/createCourse`, {
            ...
            <div className="container">
                <div className="row justify-content-sm-center"> 
                    <div className="col-12 pb-0">
                        <h1 style={{color:"rgb(90,90,90)"}} className="text-center mb-4 fs-2">Create Course</h1>
                        <form onSubmit={handleSubmit}  >
                            ...
                            <FormControl className={clsx(classes.margin, classes.textField)}>
                                ...
                                <Input
                                    style={{marginBottom:"10px"}}
                                    placeholder="Enter Course Description (Max 20 characters)"
                                    fullWidth
                                    id="description"
                                    type="textarea"
                                    margin="normal"
                            ...
                            {/* <FormControl className={clsx(classes.margin, classes.textField)}>
                                ...
                                <Input
                                    style={{marginBottom:"10px"}}
                                    placeholder="Number of Course Content Sections"
                                    fullWidth
                                    id="section"
                                    type="number"
                                    margin="normal"
