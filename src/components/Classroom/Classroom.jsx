...
const Classroom = () => {
  ...
  useEffect(() => {
    ...
    axios.post(`${HOST}/classes/getClassroom`, {
        classCode: classCode
  ...
  useEffect(async () => {
    if (storeData.token){
      ...
      axios.post(`${HOST}/classes/getReminders`, {
        ...
        .then(async (res)=>{
          ...
          for (let reminder of res.data) {
            await axios.post(`${HOST}/classes/getClassroom`, {
  ...
  const deleteClass = () => {
    axios.delete(`${HOST}/classes/deleteClassroom`, {
