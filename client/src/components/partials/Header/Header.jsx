    ...
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container-fluid">
          <>
            <NavLink to="/" className="navbar-brand ms-5 fw-bold" href="#">MARS INSTITUTES EDUCATION</NavLink>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
                ...
                <li className="nav-item mx-3">
                  <NavLink to="/browse" className="nav-link" activeClassName="selected" exact>Browse</NavLink>
                </li>
                {
                  (token) ? (
                    <li className="nav-item mx-3">
                      <NavLink to="/courses" className="nav-link" activeClassName="selected" exact>Courses</NavLink>
                    </li>
                  ) : ""
                }
                {
                  (token) ? (
                    <li className="nav-item mx-3">
                      <NavLink to="/resources" className="nav-link" activeClassName="selected" exact>Resources</NavLink>
                    </li>
                  ) : ""
                }
                {
                  (token) ? (
                    <li className="nav-item mx-3">
                      <NavLink to="/forum" className="nav-link" activeClassName="selected" exact>Discussion</NavLink>
                    </li>
                  ) : ""
                }
                
                {
                  (token) ? (
                    <li className="nav-item mx-3">
                      <NavLink to="/classes" className="nav-link" activeClassName="selected" exact>Live Classrooms</NavLink>
                    </li>
                  ) : ""
                }
                <ConditionalBtn/>
